...
const premKey = {
	...
	'account:query': ['/account/list', '/account/deletedList'],
	'account:delete': ['/account/delete', '/account/restore', '/account/purge'],
	'my:delete': ['/my/delete'],
	'role:add': ['/role/add'],
	...
	'user:add': ['/user/add'],
	'user:batch': ['/userBatch/create', '/userBatch/list', '/userBatch/items', '/userBatch/update', '/userBatch/delete', '/userBatch/precheck', '/inboxGroup/list', '/inboxGroup/members', '/inboxGroup/protect', '/inboxGroup/delete', '/inboxGroup/restore', '/inboxGroup/purge'],
