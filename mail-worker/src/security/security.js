...
const premKey = {
	...
	'user:add': ['/user/add'],
	'user:batch': ['/userBatch/create', '/userBatch/list', '/userBatch/items', '/userBatch/update', '/userBatch/delete', '/userBatch/precheck', '/inboxGroup/list', '/inboxGroup/members', '/inboxGroup/protect', '/inboxGroup/delete', '/inboxGroup/restore'],
